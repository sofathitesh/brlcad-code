...
for($pv; $pv<$pn;$pv++)
{
	echo "<form action='".home_url()."/edit.php?&article=".str_replace('docbook','wordpress',brlcad_source).$directory_name[$pv]."/".$languages[$pv]."/".str_replace("xml","php",$files_array[$pv])."' method='post'>";
