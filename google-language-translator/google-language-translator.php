...
class google_language_translator {
  ...
  public $languages_array_nagtive_name = array (
    'af' => 'Afrikaans',
    'sq' => 'shqip',
    'ar' => ' العربية',
    'hy' => 'Հայերէն',
            ...
            }else
            {
		     ...
		     foreach ($new_languages_array_codes as $value) {
			  ...
			  if ($flag_choice_key == '1') {
			    if (in_array($language_name,$this->languages_array)) {
                              if ( isset ( $get_flag_choices['flag-'.$language_code.''] ) ) {
          $str.="<tr><td style='width:15%'>".$language_name."</td><td><a title='".$language_name."' class='notranslate flag ".$language_code."'></a></td></tr>";
		              } //isset
			    } //in_array
		          }//flag_choice_key
	             }//foreach
